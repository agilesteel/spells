...
trait HumanRendering {
  ...
  implicit def intToRendering(value: Int): Rendering = new Rendering(value)
  implicit def longToRendering(value: Long): Rendering = new Rendering(value)
      ...
      object from {
        private case class Duration(
          ...
          override def toString = {
            if (days > 0) days.render.duration.days
            else if (hours > 0) {
            ...
            } else "" // TODO: render negative durations
          }

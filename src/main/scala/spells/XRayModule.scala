...
trait XrayModule {
  this: AnsiModule with AnyOpsModule with CalendarOpsModule with DateOpsModule with DurationOps with HumanRendering with StringOps with StylePrint with TraversableOps with SpellsConfig =>

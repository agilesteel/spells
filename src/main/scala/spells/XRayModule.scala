...
trait XrayModule {
  this: AnsiModule with AnyOpsModule with CalendarOpsModule with DateOpsModule with DurationOpsModule with HumanRendering with StringOps with StylePrint with TraversableOps with SpellsConfig =>

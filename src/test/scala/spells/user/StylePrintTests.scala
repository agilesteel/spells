...
class StylePrintTests extends spells.UnitTestConfiguration {
  ...
  test(
    ...
    styled("yellow".yellow + "green".green + "yellow".yellow)(Yellow) should be(
  ...
  test(
    ...
    styled("yellow" + "green".green)(Yellow) should be(
  ...
  test(
    ...
    styled("yellow".yellow + "green")(Green) should be(
      "yellow".yellow + "green".green
    )
  }
  ...
  test(
    ...
    styled("yellow" + "green".green + "yellow")(Yellow) should be(
      "yellow".yellow + "green".green + "yellow".yellow
    )
  }
  ...
  test(
    ...
    styled("yellow".yellow + "green" + "yellow".yellow)(Green) should be(
      "yellow".yellow + "green".green + "yellow".yellow
    )
  }
  ...
  test(
    ...
    styled("yellow" + "green".green + "yellow".yellow)(Yellow) should be(
      "yellow".yellow + "green".green + "yellow".yellow
    )
  }
  ...
  test(
    ...
    styled("yellow".yellow + "green".green + "yellow")(Yellow) should be(
      "yellow".yellow + "green".green + "yellow".yellow
    )
  }
  ...
  test("""Line breaks of any kind should not cause any trouble""") {
    styled("yellow\r\n" + "green".green)(Yellow) should be(
      "yellow\r\n".yellow + "green".green
    )
    styled("yellow\n" + "green".green)(Yellow) should be(
      "yellow\n".yellow + "green".green
    )
    styled("yellow\r" + "green".green + "yellow")(Yellow) should be(
      "yellow\r".yellow + "green".green + "yellow".yellow
    )
    styled("yellow\n" + "green".green + "yellow")(Yellow) should be(
      "yellow\n".yellow + "green".green + "yellow".yellow
    )
    styled("\ryellow" + "green".green + "yellow")(Yellow) should be(
      "\ryellow".yellow + "green".green + "yellow".yellow
    )
    styled("\nyellow" + "green".green + "yellow")(Yellow) should be(
      "\nyellow".yellow + "green".green + "yellow".yellow
    )
    styled("\r\r\nyellow" + "green".green + "\n\ryellow")(Yellow) should be(
      "\r\r\nyellow".yellow + "green".green + "\n\ryellow".yellow
    )
  }

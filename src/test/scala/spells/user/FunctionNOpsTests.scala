...
class FunctionNTests extends spells.UnitTestConfiguration {
  test("FunctionN rendering tests") {
    ...
    ).rendered should include regex """\(.*Int, .*Int\) => .*String"""
    (
        (
            _: Int,
            _: Int,
    ...
    ).rendered should include regex """\(.*Int, .*Int, .*Int\) => .*String"""
    (
        (
            _: Int,
            _: Int,
    ...
    ).rendered should include regex """\(.*Int, .*Int, .*Int, .*Int\) => .*String"""
    (
        (
            _: Int,
            _: Int,
    ...
    ).rendered should include regex """\(.*Int, .*Int, .*Int, .*Int, .*Int\) => .*String"""
    (
        (
            _: Int,
            _: Int,
    ...
    ).rendered should include regex """\(.*Int, .*Int, .*Int, .*Int, .*Int, .*Int\) => .*String"""
    (
        (
            _: Int,
            _: Int,
    ...
    ).rendered should include regex """\(.*Int, .*Int, .*Int, .*Int, .*Int, .*Int, .*Int\) => .*String"""
    (
        (
            _: Int,
            _: Int,
    ...
    ).rendered should include regex """\(.*Int, .*Int, .*Int, .*Int, .*Int, .*Int, .*Int, .*Int\) => .*String"""
    (
        (
            _: Int,
            _: Int,
